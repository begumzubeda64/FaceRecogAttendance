...
class mainTop:
    ...
    def __init__(self, top=None):
        ...
        self.txtLec.place(relx=0.641, rely=0.204,height=34, relwidth=0.319)
        ...
        self.Label1_3.place(relx=0.405, rely=0.356, height=35, width=152)
