...
#    Mar 24, 2021 03:03:39 PM IST  platform: Windows NT
...
def vp_start_gui():
    ...
    root = tk.Tk()
    top = Toplevel1 (root)
    view_class_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(rt, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = Toplevel1 (w)
    view_class_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.scrollClass.place(relx=0.051, rely=0.08, relheight=0.635
                , relwidth=0.898)
        ...
        self.btnEdit.place(relx=0.153, rely=0.768, height=63, width=246)
