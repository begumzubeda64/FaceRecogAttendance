...
#  Mar 30, 2021 01:24:20 PM IST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top44 {base} {
    ...
    wm geometry $top 650x450+650+150
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    wm deiconify $top
    wm title $top "Attendance - Edit Class"
    ...
    label $site_3_0.lab46 \
        ...
        -foreground $vTcl(actual_gui_fg) -text {Class Name} 
    ...
    button $site_3_0.but48 \
        ...
        -pady 0 -text Save 
    vTcl:DefineAlias "$site_3_0.but48" "btnEditClass" vTcl:WidgetProc "Toplevel1" 1
    place $site_3_0.lab46 \
        -in $site_3_0 -x 0 -relx 0.082 -y 0 -rely 0.264 -width 0 \
        -relwidth 0.232 -height 0 -relheight 0.101 -anchor nw \
        -bordermode ignore 
    place $site_3_0.ent47 \
        -in $site_3_0 -x 0 -relx 0.38 -y 0 -rely 0.264 -width 0 \
        -relwidth 0.502 -height 44 -relheight 0 -anchor nw -bordermode ignore 
